...
tags: [webshell, php, post-exploitation, rce, penetration-testing]
image:
  path: /assets/img/p0wny-shell/p0wnyshell-logo.png
  alt: "p0wnyshell logo"
description: "A practical and technical analysis of flozz/p0wny-shell, a powerful and lightweight PHP shell for RCE scenarios in web servers. Learn how it works, how to use it, and how to defend against it."
redirect_from:
  - /posts/p0wny@shell/
  - /posts/p0wny%40shell/
---
